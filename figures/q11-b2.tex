...
% F -> D
\tkzDrawSegment[->,orange,dotted](A,G)

% F -> E
\tkzDrawSegment[->,blue,dotted](D,L)
\tkzDrawSegment[->,blue, dotted](G,I)

% E -> D
\tkzDrawSegment[->,purple,thick](A,I)

\tkzDrawSegment[->,green,thick](C,K)
\tkzText[right,draw](6.68,10){${\color{orange}\vect{AG}} + {\color{blue}\vect{DL}}={\color{purple}\vect{ED}}\?{\color{green}\vect{CK}}$}
