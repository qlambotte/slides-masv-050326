...
% F -> D
\tkzDrawSegment[->,orange, dotted](F,D)

% F -> E
\tkzDrawSegment[->,blue,dotted](E,F)
...
\tkzText[right,draw](6.68,10){${\color{orange}\vect{FD}} + {\color{blue}\vect{EF}}={\color{purple}\vect{ED}}\?{\color{green}\vect{AJ}}$}
